                ...
                <form className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input type="text" placeholder="Enter your full name" className="w-full bg-slate-50 border border-slate-100 p-4 rounded-xl font-quicksand text-sm focus:outline-none focus:border-libco-red" />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-slate-900 uppercase ml-2">Email Address</label>
                      <input type="email" placeholder="Enter your email address" className="w-full bg-slate-50 border border-slate-100 p-4 rounded-xl font-quicksand text-sm focus:outline-none focus:border-libco-red" />
                    </div>
                  </div>
                  
                  <div className="space-y-1">
                    <label className="text-[10px] font-bold text-slate-900 uppercase ml-2">Inquiry Type</label>
                    <select className="w-full bg-slate-50 border border-slate-100 p-4 rounded-xl font-quicksand text-sm text-slate-500 focus:outline-none focus:border-libco-red">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea rows={3} placeholder="Provide details about the items or services needed..." className="w-full bg-slate-50 border border-slate-100 p-4 rounded-xl font-quicksand text-sm focus:outline-none focus:border-libco-red" />
                  </div>
                  
                  <button className="w-full bg-libco-red text-white font-quicksand font-black py-4 md:py-5 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-900 transition-all shadow-xl shadow-libco-red/20 uppercase text-[11px] tracking-widest mt-2">
            ...
            >
              ...
              <div className="p-6 bg-slate-50/80 border-t border-slate-100">
                <button 
                  ...
                  className="w-full font-quicksand font-extrabold text-[10px] uppercase bg-blue-600 text-white py-4 rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-blue-100"
                >
